...
#############################
	# global variables #
#############################
root_dir          = "./../Mapilliary/mapillary-vistas-dataset_public_v2.0/"
training_set      = "validation/"
training_dir      = os.path.join(root_dir, training_set)
img_dir           = os.path.join(training_dir, "images/")
gt_dir            = os.path.join(training_dir, "v2.0/labels/")
f = open(os.path.join(root_dir, "config_v2.0.json"))
